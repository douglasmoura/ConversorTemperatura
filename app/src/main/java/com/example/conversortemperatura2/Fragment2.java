...
public class Fragment2 extends Fragment {
    ...
    public Fragment2(ViewPager viewPager) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        editTextTemperatura = view.findViewById(R.id.txtNumeroTemperatura2);
        textViewResultado = view.findViewById(R.id.txtConversao2);
