...
public class Fragment4 extends Fragment {
    ...
    public Fragment4(ViewPager viewPager) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        editTextTemperatura = view.findViewById(R.id.txtNumeroTemperatura4);
        textViewResultado = view.findViewById(R.id.txtConversao4);
